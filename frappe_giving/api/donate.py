...
def get_branding():
	return {
		"giving_logo": frappe.db.get_single_value("Frappe Giving Settings", "giving_logo") or "",
	}
...
def get_default_form_name() -> str | None:
	...
	"""
	default_campaign = frappe.db.get_value("Donation Campaign", {"default": 1, "status": "Active"}, "name")
	if default_campaign:
