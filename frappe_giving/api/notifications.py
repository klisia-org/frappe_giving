...
def _build_context(donor, donation, dp, donation_name, include_account_link: bool) -> dict:
	campaign_title = (
		frappe.db.get_value("Donation Campaign", donation.campaign, "campaign_name") or donation.campaign
	)
